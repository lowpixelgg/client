          ...
          <div id="frameMain">
              ...
              <div id="frameContentWin">
                  ...
                  <div id="frameButtonDockWin">
                      <button className="frameButton fMb" id="frameButton_minimize" onClick={() => action('minimize') } >
                      ...
                      <button className="frameButton fRb" id="frameButton_restoredown" >
                      ...
                      <button className="frameButton fCb" id="frameButton_close" onClick={() => { action('close') }}>
